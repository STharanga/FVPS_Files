...
rem powershell -Command "Invoke-WebRequest https://drive.google.com/u/2/uc?id=1TrjHZl3bBX_xX3HlxWVGYj8ctHmRV61K -OutFile D:\FMD2\STIMRZ.7z"
rem powershell -Command "Invoke-WebRequest https://drive.google.com/u/2/uc?id=1eJe850TDo0VuytQXCeGIO5swpBTJDBqh -OutFile D:\FMD2\FMD2.7z"
rem powershell -Command "Invoke-WebRequest https://drive.google.com/u/2/uc?id=13vUVCAPVsPkAz0tXCGcONxqyAnvRVtE5 -OutFile D:\FMD2\userdata.7z"
